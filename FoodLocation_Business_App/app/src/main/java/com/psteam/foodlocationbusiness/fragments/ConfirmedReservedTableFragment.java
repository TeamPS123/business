...
public class ConfirmedReservedTableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentConfirmedReservedTableBinding.inflate(inflater, container, false);
    ...
    private void getAllReserveTable(){
        ...
        Call<messageAllReserveTable> call = serviceAPI.getAllReserveTables(dataTokenAndUserId.getToken(), dataTokenAndUserId.getUserId(), dataTokenAndUserId.getRestaurantId(), 4);
